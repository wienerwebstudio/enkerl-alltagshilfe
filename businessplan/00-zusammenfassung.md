# A. Kurzfassung der Geschäftsidee

Diese Executive Summary fasst zusammen, was Enkerl ist, für wen, wie das Geschäft funktioniert und wo die größten Risiken liegen.
...
Enkerl übernimmt die wiederkehrenden Aufgaben des Alltags, die mit dem Alter schwerer fallen, aber kein medizinisches Fachpersonal brauchen:

- **Haushalt** – Reinigen, Wäsche, Ordnung halten
- **Einkäufe & Besorgungen** – Lebensmittel, Apotheke, Post
- **Kochen** – frische Mahlzeiten, gern gemeinsam
- **Begleitung** – zu Arzt, Amt, beim Spaziergang
...
Enkerl leistet **keine medizinische Pflege** – also keine Tätigkeiten, die dem Pflege- oder Gesundheitsberuferecht unterliegen (z. B. Wundversorgung, Injektionen, Medikamentenmanagement im pflegerischen Sinn, Körperpflege im Sinne der Pflege). Dafür verweist Enkerl an **geprüfte Partner** (mobile Pflegedienste, Hauskrankenpflege). Diese Abgrenzung ist nicht nur Marketing, sondern gewerbe- und haftungsrechtlich zentral – siehe Spannungsfeld in den Risiken und in der [Rechts-Checkliste](06-recht-checkliste.md).

## Positionierung & Nutzenversprechen

Enkerl positioniert sich zwischen „professioneller, aber unpersönlicher Dienstleistung" und „informeller Nachbarschaftshilfe". Das Versprechen lautet: **professionell organisiert, aber menschlich nah.** Vier Versprechen tragen die Marke:
...
Wien altert – wie ganz Österreich. Der Anteil älterer Menschen an der Bevölkerung steigt strukturell, und ein wachsender Teil davon möchte (und soll, auch politisch gewollt) **so lange wie möglich daheim** statt im Heim leben („ambulant vor stationär"). Gleichzeitig wohnen Kinder und Enkel oft nicht mehr in derselben Stadt und können die Alltagsunterstützung nicht selbst leisten. Daraus entsteht eine doppelte Nachfrage: die Senior:innen brauchen Hilfe **und** die Familie sucht eine vertrauenswürdige, transparente Lösung, die sie aus der Ferne mittragen kann. Förderlogiken (Pflegegeld, Ersatz-/Verhinderungspflege, steuerliche Absetzbarkeit) können die Leistung für viele Haushalte finanzierbar machen – diese Aussagen sind jedoch **nicht gesichert** und vor Verwendung in Verkauf/Marketing zu prüfen.

> ⚠️ ZU PRÜFEN: Konkrete, aktuelle Zahlen zur Wiener Altersstruktur und Prognose (Anteil 65+/75+, Single-Haushalte älterer Menschen, Pflegegeldbezieher:innen in Wien). Quellen: **Statistik Austria**, **Stadt Wien (MA 23 – Wirtschaft, Arbeit und Statistik)**, **Fonds Soziales Wien (FSW)**. Im Businessplan keine erfundenen Prozentwerte verwenden.

## Die 3–5 größten Risiken (Kurzüberblick)
...
| 5 | **Haftung & Versicherung** | Schäden in der Wohnung, Personenbeförderung im Privat-Pkw, Lone-Worker-Schutz der Helfer:innen. | [Versicherungen](07-versicherungen.md), [Risiken](08-risiken-worstcase.md) |

---

## Offene Punkte (zu prüfen)

> ⚠️ ZU PRÜFEN: Aktuelle demografische Kennzahlen für Wien (Statistik Austria, Stadt Wien/MA 23, FSW) – im Plan nur belegte Zahlen verwenden.
